...
sub retrieve {
	...
	push @elems, SOAP::Data->prefix('sforce')->name('ids' => $id)->type('xsd:string');
    }
...
sub new {
    ...
    $self->add_port( 'name'        => 'Soap',
		     ...
		     'binding'     => Salesforce::Soap->new('address' => 'https://www.salesforce.com/services/Soap/u/4.0'));
